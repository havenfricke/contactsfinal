...
function addContact(event) {
  ...
  let contact = {
    ...
    emergencyCheck: form.emergencyCheck.checked,
  }
...
function drawContacts() {
  ...
  contacts.forEach(contact => {
    contactsTemplate += `
   <div class="contact-card mt-1 mb-1 ${contact.emergencyCheck ? 'emergency-contact' : ''}">
   <h3 class = "d-flex space-between">${contact.contactName}</h3>
   <p>
